    ...
    [179], {
        ...
        4534: function(e, t, r) {
            ...
            function G() {
                return (G = g(function*() {
                    ...
                    let e = a.assetPrefix || "";
                    if (r.p = "".concat(e, "/main/"), C.setConfig({
                            serverRuntimeConfig: {},
            ...
            t.default = class {
                ...
                getDataHref(e) {
                    ...
                    return (e => {
                        ...
                        return a.addBasePath("/main/data/".concat(this.buildId).concat(t).concat(p), !0)
        ...
        2497: function(e, t, r) {
            ...
            function d(e, t) {
                return c().then(r => {
                    ...
                    let a = r[t].map(t => e + "/main/" + encodeURI(t));
                    return {
        ...
        7429: function(e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return (e.buildId || !e.trailingSlash) && (t = n.removeTrailingSlash(t)), e.buildId && (t = o.addPathSuffix(a.addPathPrefix(t, "/main/data/".concat(e.buildId)), "/" === e.pathname ? "index.json" : ".json")), t = a.addPathPrefix(t, e.basePath), !e.buildId && e.trailingSlash ? t.endsWith("/") ? t : o.addPathSuffix(t, "/") : n.removeTrailingSlash(t)
            };
            var n = r(12),
                a = r(4135),
                o = r(6074),
        ...
        8756: function(e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (i && o.pathHasPrefix(u.pathname, i) && (u.pathname = a.removePathPrefix(u.pathname, i), u.basePath = i), !0 === t.parseData && u.pathname.startsWith("/main/data/") && u.pathname.endsWith(".json")) {
                    let c = u.pathname.replace(/^\/main\/data\//, "").replace(/\.json$/, "").split("/"),
                        d = c[0];
